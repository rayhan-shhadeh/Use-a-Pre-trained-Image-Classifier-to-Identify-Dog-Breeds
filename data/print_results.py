...
def print_results(results_dic, results_stats_dic, model, 
    ...
    # If print_incorrect_dogs is True and there were any misclassified dogs, print them
    ...
    # If print_incorrect_breed is True and there were any misclassified breeds, print them
